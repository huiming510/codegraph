<%-- ＵＴＦ－８ --%><%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%><%--
...
--%><%@ taglib prefix="vamp" uri="http://www.suumo.jp/co/rct/suumo/amazon/analytics/customtag" %><%--
--%><jj:debugPrint />
